...
export const cancelFollow = user_id => post('/user/CancelFollow',user_id)
...
export const undoFollow = user_id => post('/user/CancelFollow',user_id)
...
export const getAppealPic= params => get('/user/getAppealPic', params)
export const handleAppeal = params => post('/user/handleAppeal', params)
export const changeViewTime = params => post('/portal/visitportal', params)
export const getViewTime= params => get('/portal/getvisit', params)
